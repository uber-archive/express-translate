...
ExpressTranslate.prototype.interpolate = function (string, interpolations, options) {
  ...
  var e = this.settings.escapeHtml ? escapeHtml : function (s) { return s; };
  ...
  var intPrefix = e(this.settings.interpolationPrefix);
  var intSuffix = e(this.settings.interpolationSuffix);
  ...
  keys.forEach(function interpolateTranslationValues(key) {
    ...
    var intValue = whitelistedKeys[key] ? value : e(value);
